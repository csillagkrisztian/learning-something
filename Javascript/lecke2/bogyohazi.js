...
let insHaveOrNot = Boolean(korhazunk.doktorok[0].paciensek[0].insurance);
let insHaveOrNot2 = Boolean(korhazunk.doktorok[0].paciensek[1].insurance);
let insHaveOrNot3 = Boolean(korhazunk.doktorok[1].paciensek[0].insurance);
let insHaveOrNot4 = Boolean(korhazunk.doktorok[1].paciensek[1].insurance);
